...
GH_OWNER = "Xubuntu"
GH_REPO = "ubiquity-slideshow-xubuntu"

LP_SOURCE_NAME = "ubiquity-slideshow-ubuntu"
LP_SOURCE_URL_NAME = "ubiquity-slideshow-ubuntu"
LP_SOURCE_TAGS = "xubuntu"
...
def lp_package_get_bugs(package, status_list, get_messages = False):
    ...
    bug_tasks = package.searchTasks(status=status_list, tags=LP_SOURCE_TAGS)
    bugs = {}
